  ...
  return (
    <div className="h-screen  flex flex-col items-center justify-center gap-12 ">
      <div>
        ...
        <div className="min-w-[75%]  leading-7 mx-auto p-14 text-[#ffffff] text-center text-base md:text-xl tracking-tighter sm:tracking-tight md:tracking-normal shadow-[0_0_10px_1px_rgba(0,0,40)] backdrop-blur-xl ">
